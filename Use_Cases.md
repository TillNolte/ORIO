...
Ziel: mögliche Dubletten anhand Hostname/IP erkennen und in der Übersicht kennzeichnen; korrekten Datensatz festlegen; Alternativdatensatz korrigieren oder mit Hinweis versehen; Entscheidung historisieren.
...
Ziel: Fortschritt/Statuszahlen ohne Ziel-/Deadline-Pflicht anzeigen; nach Standort/Kampagne filtern; Auto-Aktualisierung; Teamleiter-Übersicht standardmäßig read-only; Kampagnenfortschritt unabhängig, historisch vergleichbar und auf Ist-Daten berechnen.
